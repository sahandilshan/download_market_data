...
def check_market_data_order(csv_path):
    # Read the CSV file
    ...
    return is_open_time_sorted, is_close_time_sorted


if __name__ == "__main__":
    csv_path = "combined_data.csv"  # Replace with the path to your CSV file
    print(os.getcwd())
    is_open_time_sorted, is_close_time_sorted = check_market_data_order(csv_path)
